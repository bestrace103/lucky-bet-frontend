...
export function RegisterDialog({ open, onClose }: RegisterConfirmProps) {
  ...
  const [isChecked, setIsChecked] = useState<any>({ first: false, second: false });
    ...
    <Stack>
      <Stack flexDirection="row" alignItems="center" spacing={0.5}>
        <Checkbox
          ...
          onChange={(e) => setIsChecked({ ...isChecked, first: e.target.checked })}
        />
        <Typography
          variant="body2"
        ...
        >
          I agree to the{' '}
          <Link underline="hover" color="white" sx={{ cursor: 'pointer' }}>
            User Agreement
          </Link>
      ...
      <Stack flexDirection="row" alignItems="center" spacing={0.5}>
        <Checkbox
          onChange={(e) => setIsChecked({ ...isChecked, second: e.target.checked })}
        ...
        <Typography
          ...
          sx={{ lineHeight: 1.2 }}
        >
          I agree to receive marketing promotions from WinX100
        </Typography>
      </Stack>
    </Stack>
  );
